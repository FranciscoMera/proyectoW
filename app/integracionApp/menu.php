...
<nav>
    <div class="nav-wrapper ">
        ...
        <ul id="nav-mobile" class="right hide-on-med-and-down">
            ...
            <li><a href="consultarPerfil.php"><i class="material-icons right">account_circle</i><?php echo $empleadoIntegracion->getNombreEmpleado()."<br>".$empleadoIntegracion->getPuesto() ?></a></li>
